...
public class Logger {
	...
	/**
	 * Prints a message under the GENERAL flag. Should only be used for quick
	 * debugging and replaced with a specific flag afterwards
	 * 
	 * @param message
	...
	public void print(final String message) {
		print(message, LogMessageType.GENERAL);
	}
